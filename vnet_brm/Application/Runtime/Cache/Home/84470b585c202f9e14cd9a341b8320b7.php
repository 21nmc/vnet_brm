            ...
            <div class="content no-sidebar " id="root">
                <div class="home-list">
                    <div class="dismaptitle">
                        <div class="map1title">账户管理</div><div class="mapment"><a href="<?php echo U('Mobile/index');?>">首页</a>>>账户管理</div>
                    </div>
                    <div class="mapbox">
                        <div class="chatitle">修改密码</div>
                        <div class="mapsearchbox">
                          <form name="form1" method="post">
                            <div class="clashang">原密码：<input type="text" name="old"></div>
                            <div class="clashang">新密码：<input type="password" name="password"></div>
                            <div class="clashang">确认新密码：<input type="password" name="repassword"></div>
