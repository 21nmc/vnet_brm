...
class  WeekreportController extends HomeController {
    //出口带宽分布
    public function index(){
        $Demo = M('traffic_newzichan');
        ...
        $count = $Demo->where('section in ('.$depart_id.')')->count();
        ...
        $list=$Demo->where('section in ('.$depart_id.')')->order('id desc')->limit($page->firstRow,$page->listRows)->select();
